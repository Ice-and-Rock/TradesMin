 ...
 export const CreateProject = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log("new project added:", [project][0].project_name);
    } catch (error) {
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="flex mb-4">
              <input
                ...
                className="w-full min-w-[140px] p-2 border border-gray-300 rounded-md mb-1 mr-2 bg-gray-200 focus:outline-none focus:ring focus:border-pink-600"
              ...
              <input
                ...
                className="w-full p-2 border border-gray-300 rounded-md mb-1 mr-2 bg-gray-200 focus:outline-none focus:ring focus:border-pink-600"
              ...
              <button
                type="button"
                onClick={addMaterial}
                className="bg-blue-500 text-white px-3 mb-2 rounded-full shadow-xl hover:bg-blue-700"
              >
                Add
              </button>
            </div>
            ...
            <div>
              {!isPending && (
                <button className="bg-pink-500 text-white px-4 py-2 my-2 rounded-md shadow-xl cursor-not-allowed">
                  Add project!
                </button>
              )}
              {isPending && (
